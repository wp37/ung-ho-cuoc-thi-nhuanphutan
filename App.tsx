...
const FOMO_NAMES = [
  ...
  // Danh sách mới (số 6–30)
  { role: 'Cô', name: 'Lê Thị Diễm' },
  { role: 'Cô', name: 'Võ Thị Thanh Trúc' },
  { role: 'Thầy', name: 'Huỳnh Văn Bình' },
  { role: 'Cô', name: 'Huỳnh Thị Lắm' },
  { role: 'Thầy', name: 'Phạm Văn Đông' },
  { role: 'Thầy', name: 'Trần Văn Thái' },
  { role: 'Cô', name: 'Nguyễn Thanh Hiền' },
  { role: 'Cô', name: 'Nguyễn Thị Ngọc Trinh' },
  { role: 'Thầy', name: 'Nguyễn Văn Hiệp' },
  { role: 'Thầy', name: 'Dương Minh Bằng' },
  { role: 'Cô', name: 'Lâm Thị Mỹ Nhanh' },
  { role: 'Cô', name: 'Thạch Kim Hiền' },
  { role: 'Thầy', name: 'Dương Văn Thảo' },
  { role: 'Thầy', name: 'Nguyễn Hùng Cường' },
  { role: 'Thầy', name: 'Phạm Văn Hòa' },
  { role: 'Cô', name: 'Trần Thị Minh Loan' },
  { role: 'Cô', name: 'Lê Thị Kim Châu' },
  { role: 'Thầy', name: 'Võ Đông Xuân' },
  { role: 'Thầy', name: 'Lê Ngọc Lào' },
  { role: 'Thầy', name: 'Phạm Văn Quân' },
  // Học sinh
